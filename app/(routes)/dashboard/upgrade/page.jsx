  ...
  return (
    <div className='h-96 flex flex-col justify-center items-center'>
      ...
      <CardHeader>
        ...
        <CardDescription>Get all source code for this project</CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4">
        <Link href="https://github.com/sabberrahman/Sanji-Dashboard" target='_blank'>
        <div className=" flex items-center space-x-4 rounded-md border p-4 hover:shadow-lg hover:border-red-400">
          <div>
